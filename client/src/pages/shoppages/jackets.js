...
const Jackets = () => {
    ...
    var currentposts=jackets.slice(firstPostIndex,lastpostIndex)
    console.log(currentposts)
  return (
    <div className='sneakershopcontainer'>
         {/* <p style={{fontFamily:"monospace"}}>Sneakers</p> */}
        <ItemCardDetails sneakersdata={currentposts}/>
        <Pagination totalPosts={jackets.length} postperpage={postperpage} setcurrentPage={setCurrentPage} name="jackets" />
    </div>
  )
}
